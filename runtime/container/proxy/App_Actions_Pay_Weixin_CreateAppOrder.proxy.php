...
class CreateAppOrder extends AbstractAction
{
    ...
    /**
     * @api {post} /pay/weixin/createAppOrder 创建APP订单
     * @apiDescription 创建公众号订单  对应文档https://doc.yurunsoft.com/PaySDK/111  官方文档：https://pay.weixin.qq.com/wiki/doc/api/app/app.php?chapter=8_1
     ...
     * @apiSuccess {string} data.prepayId 预支付交易会话标识
    ...
    public function handle()
    {
        ...
        $res = $this->weixinPayService->createAppOrder($tradeNo, $goodsInfo, $totalFee, $clientIP);
        if ($res['ok']) {
